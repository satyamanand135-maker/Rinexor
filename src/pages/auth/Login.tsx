...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (roleParam === 'super_admin') {
      setEmail('superadmin@rinexor.ai');
      setPassword('Super@123');
    } else if (roleParam === 'enterprise_admin') {
      setEmail('admin@enterprise.com');
      setPassword('Enterprise@123');
    } else if (roleParam === 'dca_agent') {
      setEmail('agent@dca.com');
      setPassword('DCA@123');
    }
  }, [roleParam, navigate]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (roleParam === 'super_admin' && email === 'superadmin@rinexor.ai' && password === 'Super@123') isValid = true;
      if (roleParam === 'enterprise_admin' && email === 'admin@enterprise.com' && password === 'Enterprise@123') isValid = true;
      if (roleParam === 'dca_agent' && email === 'agent@dca.com' && password === 'DCA@123') isValid = true;
         ...
         <div className="p-8">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
               <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium border border-blue-100">
                  <span>Hackathon Mode: Credentials Pre-filled</span>
               </div>
            </div>
         </div>
       </div>
